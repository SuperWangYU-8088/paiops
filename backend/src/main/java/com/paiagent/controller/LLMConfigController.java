...
public class LLMConfigController {
    ...
    public Result<List<LLMGlobalConfig>> listAll() {
        List<LLMGlobalConfig> configs = llmGlobalConfigService.listSafeConfigs();
        return Result.success(configs);
    }
    ...
    public Result<LLMGlobalConfig> getById(@PathVariable Long id) {
        LLMGlobalConfig config = llmGlobalConfigService.getSafeById(id);
        if (config == null) {
    ...
    public Result<LLMGlobalConfig> getDefaultConfig(@PathVariable String provider) {
        LLMGlobalConfig config = llmGlobalConfigService.getSafeDefaultConfig(provider);
        return Result.success(config);
    }
