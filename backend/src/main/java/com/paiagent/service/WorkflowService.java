...
public class WorkflowService extends ServiceImpl<WorkflowMapper, Workflow> {
    ...
    private final WorkflowSecretPolicy workflowSecretPolicy;

    public WorkflowService(WorkflowSecretPolicy workflowSecretPolicy) {
        this.workflowSecretPolicy = workflowSecretPolicy;
    }
    ...
    public WorkflowResponse createWorkflow(WorkflowRequest request) {
        workflowSecretPolicy.assertNoInlineSecrets(request.getFlowData());
